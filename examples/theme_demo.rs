...
use agentic::theme::{Element, Theme, ThemeVariant};
...
fn main() {
    ...
    println!(
        "  Background: {:?}",
        dark_theme.bg_color(Element::Background)
    );
