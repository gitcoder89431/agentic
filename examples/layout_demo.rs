...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for (width, height) in test_sizes {
        ...
        println!(
            "  Header: {}x{} at ({}, {})",
            rects.header.width, rects.header.height, rects.header.x, rects.header.y
        );

        println!(
            "  Body:   {}x{} at ({}, {})",
            rects.body.width, rects.body.height, rects.body.x, rects.body.y
        );

        println!(
            "  Footer: {}x{} at ({}, {})",
            rects.footer.width, rects.footer.height, rects.footer.x, rects.footer.y
        );
        ...
        assert_eq!(
            rects.body.height, expected_body_height,
